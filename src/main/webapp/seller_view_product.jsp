...
%>
	...
	<li class="span3">
		<div class="thumbnail">
			<a href="product_detail.jsp"><img src="product_images/<%=p.getProduct_image() %>" alt="" width="400px" height="200px"/></a>
				<div class="caption">
				<h5><%=p.getProduct_name() %></h5>
				<h4><a class="btn btn-primary" href="seller_product_details.jsp?pid=<%=p.getId()%>">Product Details</a>
				<a class="btn btn-primary" href="#">Price: <%=p.getProduct_price()%></a>
				<a class="btn btn-info" href="#">Add to Cart <i class="icon-shopping-cart"></i></a>
				<a class="btn btn-info" href="#">Add to Wishlist</a>
				</h4>
