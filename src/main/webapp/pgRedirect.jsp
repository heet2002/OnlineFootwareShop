...
parameters.put("TXN_AMOUNT",request.getParameter("TXN_AMOUNT").toString());
parameters.put("MOBILE_NO","7016262396");
parameters.put("EMAIL","akshaymehta6121@gmail.com");
parameters.put("CALLBACK_URL", "http://localhost:8080/TopsProject/pgResponse.jsp");
